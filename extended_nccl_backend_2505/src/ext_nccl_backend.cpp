...
c10::intrusive_ptr<Work> ExtProcessGroupNCCL::alltoall_base(
  ...
  printf("ExtProcessGroupNCCL::alltoall_base, fake overrided from ProcessGroupNCCL\n");
  ...
  if (outputSplitSizes.empty() && inputSplitSizes.empty()) {
    ...
    return collective(
      inputTensor,
      outputTensor,
      /** NOTE: invalid to use llama function here */
      // [&](at::Tensor& input,
      //     at::Tensor& output,
      //     ncclComm_t comm,
      ...
      //   return ncclSuccess;
      // },
      All2AllSingleEqualSplitFunctor(this->getSize()),
    ...
    return collective(
      ...
      //   return ncclSuccess;
      // },
      All2AllSingleUnequalSplitFunctor(this->getSize(), inputSplitSizes, outputSplitSizes),
      OpType::ALLTOALL_BASE,
      opts.asyncOp,
      "nccl:all_to_all"
    );
