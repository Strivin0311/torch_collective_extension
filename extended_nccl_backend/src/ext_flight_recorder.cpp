...
std::string ExtFlightRecorder::Entry::getTraceback() {
...
std::optional<size_t> ExtFlightRecorder::record(
    size_t pg_id,
...
void ExtFlightRecorder::record_pg_ranks(
    const std::tuple<std::string, std::string>& pg_name,
...
void ExtFlightRecorder::update_state(Entry& r) {
if (r.start_ != nullptr) {
...
std::vector<ExtFlightRecorder::Entry> ExtFlightRecorder::dump_entries() {
std::lock_guard<std::mutex> guard(mutex_);
...
// std::nullopt.
std::optional<ExtFlightRecorder::Entry> ExtFlightRecorder::getEntry(
...
void ExtFlightRecorder::retire_id(
    std::optional<size_t> id,
...
const c10::List<c10::IValue> ExtFlightRecorder::getCollectiveTrace(
...
const c10::Dict<c10::IValue, c10::IValue> ExtFlightRecorder::getPgConfig() {
...
const std::map<std::string, std::map<std::string, std::string>> ExtFlightRecorder::
    getPgConfigJson() {
...
const c10::Dict<c10::IValue, c10::IValue> ExtFlightRecorder::getPgStatus() {
...
// std::string ExtFlightRecorder::dump_json(
...
std::string ExtFlightRecorder::dump(
    const std::optional<std::unordered_map<
        std::string,
        std::unordered_map<std::string, std::string>>>& ncclDumpMap,
    bool includeCollectives,
