...
class TORCH_API ExtProcessGroupNCCL : public Backend {
 public:
  ...
  static void ExtProcessGroupNCCLConstructor() __attribute__((constructor)) {
    ...
    register_backend("ext_nccl_backend", py::cpp_function(createExtProcessGroupNCCL));
  }
};

class WorkExtNCCL : public Work {
